...
@section('body.breadcrumbs')
        {{ Breadcrumbs::render('model.edit',$model->name) }}
@stop
@section('styles')
...
@section('body.content')
    ...
    <form role="form" method="post" action="{{route('model.edit',['id' => $model->id])}}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-8">
                <!-- create manager form -->
                <div class="box box-success">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    <label>Name</label>
                                    <input name="name" value="{{$model->name}}" type="text" class="form-control" placeholder="Enter ..." required>
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="brand_id" class="form-control" required>
                                        ...
                                        @foreach($brands as $brandItem)
                                            <option value="{{$brandItem->id}}" @if($model->brand_id == $brandItem->id) selected @endif>{{$brandItem->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" placeholder="Enter...." rows="5">{{$model->description}}</textarea>
                                </div>
                            </div>
                            <div class="col-xs-6">
                    ...
                    <div class="box-footer">
                        <a href="{{route('model.delete',['id' => $model->id])}}" class="btn btn-danger">Delete</a>
