        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-6 col-sm-push-3">
                    <form role="form" method="post" action="{{route('tag.create')}}" enctype = "multipart/form-data">
                        {{ csrf_field() }}
                        @if ($errors->any())
                        ...
                        <div class="form-group{{ $errors->has('tag_name') ? ' has-error' : '' }}">
                            ...
                            <input name="tag_name" value="{{ old('tag_name') }}" type="text" class="form-control" placeholder="Enter ..." required>
